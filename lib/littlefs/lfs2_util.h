...
#include <assert.h>
#endif
#if !defined(LFS2_NO_DEBUG) || !defined(LFS2_NO_WARN) ||                       \
    !defined(LFS2_NO_ERROR) || defined(LFS2_YES_TRACE)
#include <stdio.h>
#endif
...
static inline uint32_t lfs2_tole32(uint32_t a) { return lfs2_fromle32(a); }
...
static inline uint32_t lfs2_tobe32(uint32_t a) { return lfs2_frombe32(a); }
