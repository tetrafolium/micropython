...
bool usb_vcp_is_enabled(void) { return true; }

int usb_vcp_rx_num(void) { return usb_serial_available(); }
...
void usb_vcp_send_str(const char *str) { usb_vcp_send_strn(str, strlen(str)); }
