...
TimerHandle_t xTimerCreate(
    ...
    TimerCallbackFunction_t
        pxCallbackFunction) /*lint !e971 Unqualified char types are allowed for
                               strings and single characters only. */
{
  Timer_t *pxNewTimer;
...
TimerHandle_t xTimerCreateStatic(
    ...
    TimerCallbackFunction_t pxCallbackFunction,
    StaticTimer_t
        *pxTimerBuffer) /*lint !e971 Unqualified char types are allowed for
                           strings and single characters only. */
{
  Timer_t *pxNewTimer;
  ...
  pxNewTimer = (Timer_t *)
      pxTimerBuffer; /*lint !e740 Unusual cast is ok as the structures are
...
BaseType_t xTimerIsTimerActive(TimerHandle_t xTimer) {
  ...
  taskENTER_CRITICAL();
  {
    ...
    xTimerIsInActiveList = (BaseType_t) !(
        listIS_CONTAINED_WITHIN(NULL, &(pxTimer->xTimerListItem)));
  }
  taskEXIT_CRITICAL();
