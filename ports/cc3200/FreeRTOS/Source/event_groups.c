...
xEventGroupCreateStatic(StaticEventGroup_t *pxEventGroupBuffer) {
  ...
  pxEventBits = (EventGroup_t *)
      pxEventGroupBuffer; /*lint !e740 EventGroup_t and StaticEventGroup_t are
                             guaranteed to have the same size and alignment
                             requirement - checked by configASSERT(). */
...
EventBits_t xEventGroupSetBits(EventGroupHandle_t xEventGroup,
  ...
  pxListEnd = listGET_END_MARKER(
      pxList); /*lint !e826 !e740 The mini list structure is used as the list
