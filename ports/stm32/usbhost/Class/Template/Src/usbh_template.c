 ...
 * @brief    This file includes TEMPLATE Layer Handlers for USB Host TEMPLATE
 * class.
 * @{
 */
...
USBH_TEMPLATE_InterfaceInit(USBH_HandleTypeDef *phost);

static USBH_StatusTypeDef
USBH_TEMPLATE_InterfaceDeInit(USBH_HandleTypeDef *phost);
...
USBH_ClassTypeDef TEMPLATE_Class = {"TEMPLATE",
                                    USB_TEMPLATE_CLASS,
 ...
 */
static USBH_StatusTypeDef
USBH_TEMPLATE_ClassRequest(USBH_HandleTypeDef *phost) {
 ...
 *         The function is for managing state machine for TEMPLATE data
 * transfers
 * @param  phost: Host handle
 * @retval USBH Status
 */
