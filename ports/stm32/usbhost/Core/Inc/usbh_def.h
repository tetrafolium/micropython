...
#define USB_DESC_DEVICE_QUALIFIER                                              \
  ((USB_DESC_TYPE_DEVICE_QUALIFIER << 8) & 0xFF00)
...
#define CONFIG_DESC_wTOTAL_LENGTH                                              \
  (ConfigurationDescriptorData.ConfigDescfield.ConfigurationDescriptor         \
       .wTotalLength)
...
typedef enum { CMD_IDLE = 0, CMD_SEND, CMD_WAIT } CMD_StateTypeDef;
