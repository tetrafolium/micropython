 ...
 * @brief   This file implements the board support package for the USB host
 *library
 ******************************************************************************
 * @attention
 *
 ...
 * @retval USBH Status
 */
USBH_StatusTypeDef USBH_LL_Init(USBH_HandleTypeDef *phost) { return USBH_OK; }
 ...
 * @retval USBH Status
 */
USBH_StatusTypeDef USBH_LL_DeInit(USBH_HandleTypeDef *phost) { return USBH_OK; }
 ...
 * @retval USBH Status
 */
USBH_StatusTypeDef USBH_LL_Start(USBH_HandleTypeDef *phost) { return USBH_OK; }
 ...
 * @retval USBH Status
 */
USBH_StatusTypeDef USBH_LL_Stop(USBH_HandleTypeDef *phost) { return USBH_OK; }
