// Note: if the board shows odd behaviour check the option bits and make sure
// nDBANK is set to make the 2MByte space continuous instead of divided into two
// 1MByte segments.
...
// SD card detect switch (actual pin may need to be changed for a particular
// use)
