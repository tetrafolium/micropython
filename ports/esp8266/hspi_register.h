...
#define SPI_CTRL1(i)                                                           \
  (REG_SPI_BASE(i) + 0xC) // From previous SDK. Removed _FLASH_ from name to
...
#define SPI_MOSI_DELAY_MODE                                                    \
  0x00000003 // mode 0 : posedge; data set at positive edge of clk
// mode 1 : negedge + 1 cycle delay, only if freq<10MHz ; data set at negitive
// edge of clk mode 2 : Do not use this mode.
...
#define SPI_EXT0(i)                                                            \
  (REG_SPI_BASE(i) + 0xF0) // From previous SDK. Removed _FLASH_ from name to
                           // match other registers.
...
#define SPI_EXT1(i)                                                            \
  (REG_SPI_BASE(i) + 0xF4) // From previous SDK. Removed _FLASH_ from name to
                           // match other registers.
...
#define SPI_EXT2(i)                                                            \
  (REG_SPI_BASE(i) + 0xF8) // From previous SDK. Removed _FLASH_ from name to
                           // match other registers.
