...
static inline mp_uint_t mp_hal_ticks_ms(void) { return k_uptime_get(); }
...
static inline void mp_hal_delay_us(mp_uint_t delay) { k_busy_wait(delay); }

static inline void mp_hal_delay_ms(mp_uint_t delay) { k_msleep(delay); }
...
#define mp_hal_pin_od_high(p)                                                  \
  (mp_raise_NotImplementedError("mp_hal_pin_od_high"))
#define mp_hal_pin_open_drain(p)                                               \
  (mp_raise_NotImplementedError("mp_hal_pin_open_drain"))
